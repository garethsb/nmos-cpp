#ifndef NMOS_ANNOTATION_API_H
#define NMOS_ANNOTATION_API_H
...
namespace nmos
{
    ...
    web::http::experimental::listener::api_router make_annotation_api(nmos::model& model, annotation_patch_merger merge_patch, web::http::experimental::listener::route_handler validate_authorization, slog::base_gate& gate);

    inline web::http::experimental::listener::api_router make_annotation_api(nmos::model& model, annotation_patch_merger merge_patch, slog::base_gate& gate)
    {
        return make_annotation_api(model, std::move(merge_patch), {}, gate);
    }
