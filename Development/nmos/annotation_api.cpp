...
namespace nmos
{
    ...
    web::http::experimental::listener::api_router make_annotation_api(nmos::model& model, nmos::annotation_patch_merger merge_patch, web::http::experimental::listener::route_handler validate_authorization, slog::base_gate& gate)
    {
        ...
        {
            annotation_api.support(U("/x-nmos/") + nmos::patterns::annotation_api.pattern + U("/?"), validate_authorization);
            annotation_api.support(U("/x-nmos/") + nmos::patterns::annotation_api.pattern + U("/.*"), validate_authorization);
        }
    ...
    namespace details
    {
        ...
        {
            // reject changes to read-only tags
